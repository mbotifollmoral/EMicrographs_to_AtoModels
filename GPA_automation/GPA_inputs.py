...
# Image directory
image_path=r'E:\Arxius varis\PhD\2nd_year\Code\trial_images\dm3_atomic_resolution\IS239_001_0012_0.dm3'
#IS239_001_0012_0.dm3
...
# Downscale the image if wanted, which does not change the FFT calibration
...
exx, eyy, exy, eyx, rot, shear=GPA_sp.GPA_full(image_array, im_calibration,spot1, spot2, mask_size, scaled_reference_coords, rotation_angle,display=True)
