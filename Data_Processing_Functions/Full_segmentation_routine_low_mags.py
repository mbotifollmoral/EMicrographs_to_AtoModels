# -*- coding: utf-8 -*-
"""
Created on Fri Oct 16 18:59:37 2020
...
'''
The whole rutine all together. With all the previously built function. All of them together should shine light on 
the weak points, and elements that need to be more carefully considered, to make it fully reproducible and suitable
for any NW and hyprid system studied
'''
...
downscaling_factor=32  #for trials, n factor of downsampling size of image
...
imagepath=r'E:\Arxius varis\PhD\2nd_year\Code\trial_images\full_device_STEM_datasets\SQ20-250-2\16.14.33 Scanning Acquire_0.dm3'
imagedm3=hs.load(imagepath)
image=np.asarray(imagedm3)
...
'''
labels_ms,clusters_ms=Mean_shift(ds_image_st)t
...
final_image=Multiple_Consecutive_Clustered_regions(labels_ms_reshaped, criteria='Num_Clusters', tolerance=0, n_clusters=number_final_regions)
