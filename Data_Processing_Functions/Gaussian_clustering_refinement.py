# -*- coding: utf-8 -*-
"""
Created on Tue Nov 10 14:08:17 2020
...
labels, means, covs=GMM(ds_image_st,number_clusters=number_clusters_final)
print(means)
print(covs)
...
for mean, cov in zip(means, covs):
    mean_real=mean[0]
    cov_real=cov[0][0]
    y_vals=gaussian(x, mean_real, cov_real)
    y.append(y_vals)
...
plt.imshow(labels, cmap=plt.cm.gray, vmin=labels.min(), vmax=labels.max())
plt.show()
